#!/usr/bin/env node
// Tiny stub MCP child server used by test-composer.mjs to verify the composer
// spawns children and calls *_wellness_context correctly. The stub speaks JSON-RPC over stdio
// just like a real MCP server.
...
server.registerTool(
  `${vendor}_wellness_context`,
  {
    ...
    description: 'Synthetic wellness_context emitted by the test harness.',
